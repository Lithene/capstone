...
def get_decile_score(predictions, ground_truth_col, predict_col, predict_proba_col):
    ...
    """
    This function portions the results into seperate deciles. This helps differentiate
    the portion of predictions that can be used by the business.

    Args:
      predictions: filepath to create
    Returns:
